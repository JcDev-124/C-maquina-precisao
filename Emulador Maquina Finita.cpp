...
void normalizarNega(double numero,char normalizado[maxtam], char bin[maxtam],int mantissa, int *contador, int *tamnumero){
	...
	int i =0,posic=0;
		...
		posic = i; // salvo a posicao do vetor onde come�a os digitos
...
int main(){
    ...
    do
    {
        ...
        case 1:
            ...
            break;
        case 2:
        	printf("Configura��o atual da m�quina: (Num: %lf | M :%d | L: %d | U: %d)\n", numero,mantissa,menorE,maiorE);
        ...
        case 3://Sair do programa
			...
			if(numero<0){
				printf("*****Empregando as tres representa��es*****\n\n");
				if(numero>=(-0.99999999999999999999999) && numero <= 0.99999999999999999999999 ){
        ...
        printf("[1] - Alterar configura��es.\n");
		printf("[2] - Manter configura��es.\n");
		scanf("%i", &ops);
		while(ops!=1 && ops!=2){
		printf("Op��o inv�lida.\nDigite novamente uma op��o. \n");
   		scanf("%d",&ops); 
